...
namespace VULKAN_HPP_NAMESPACE
{
  ...
  enum class StructureType
  {
    ...
    ePipelineTessellationStateCreateInfo                     = VK_STRUCTURE_TYPE_QVkPipelineESSELLATION_STATE_CREATE_INFO,
    ...
    ePipelineTessellationDomainOriginStateCreateInfo         = VK_STRUCTURE_TYPE_QVkPipelineESSELLATION_DOMAIN_ORIGIN_STATE_CREATE_INFO,
    ePipelineTessellationDomainOriginStateCreateInfoKHR      = VK_STRUCTURE_TYPE_QVkPipelineESSELLATION_DOMAIN_ORIGIN_STATE_CREATE_INFO_KHR,
    ...
    eCopyBufferToImageInfo2                                  = VK_STRUCTURE_TYPE_COPY_QVkBufferO_IMAGE_INFO_2,
    eCopyBufferToImageInfo2KHR                               = VK_STRUCTURE_TYPE_COPY_QVkBufferO_IMAGE_INFO_2_KHR,
    ...
    ePhysicalDeviceDescriptorBufferTensorFeaturesARM             = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DESCRIPTOR_QVkBufferENSOR_FEATURES_ARM,
    ePhysicalDeviceDescriptorBufferTensorPropertiesARM           = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DESCRIPTOR_QVkBufferENSOR_PROPERTIES_ARM,
