...
bool _DragScalarN(const char *label, float *v, int v_number, float v_speed, float v_min, float v_max, const char *format)
{
    assert(v_number <= 4);
    ...
    // if v_number < 1
    if (ImGui::DragFloat("", v, v_speed, v_min, v_max, format))
        trigger = true;
...
bool QkImGuiBegin(const char *title, bool* p_open, ImGuiWindowFlags flags)
{
    bool retval;
    ImGuiStyle &style = ImGui::GetStyle();
...
bool QkImGuiDragFloat2(const char *label, float *v, float v_speed, float v_min, float v_max, const char *format)
{
    return _DragScalarN(label, v, 2, v_speed, v_min, v_max, format);
}

bool QkImGuiDragFloat3(const char *label, float *v, float v_speed, float v_min, float v_max, const char *format)
{
    return _DragScalarN(label, v, 3, v_speed, v_min, v_max, format);
}

bool QkImGuiDragFloat4(const char *label, float *v, float v_speed, float v_min, float v_max, const char *format)
{
    return _DragScalarN(label, v, 4, v_speed, v_min, v_max, format);
}

void QkImGuiColorEdit3(const char* label, float *col, ImGuiColorEditFlags flags)
{
    ImGui::PushID(label);
    ImGui::Indent(32.0f);
    ImGui::TextUnformatted(label);
...
void QkImGuiSliderFloat(const char* label, float* v, float v_min, float v_max, const char* format, ImGuiSliderFlags flags)
{
    ImGui::PushID(label);
    ImGui::Indent(32.0f);
    ImGui::TextUnformatted(label);
